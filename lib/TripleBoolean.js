...
var TripleBoolean = function (_Component) {
    ...
    function TripleBoolean(props) {
        ...
        _this.displaySwitch = function () {
            return _react2.default.createElement(
                'div',
                { style: { padding: "20px" } },
                _this.props.form.title,
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(_core.FormControlLabel, {
                        ...
                        control: _react2.default.createElement(_core.Checkbox, { onClick: function onClick(e) {
                                return _this.props.onChangeValidate(e, 'yes');
                            },
                            checked: _this.state.yesChecked }) }),
                    _react2.default.createElement(_core.FormControlLabel, {
                        label: 'No',
                        control: _react2.default.createElement(_core.Checkbox, { onClick: function onClick(e) {
                                return _this.props.onChangeValidate(e, 'no');
                            },
                            checked: _this.state.noChecked }) })
                ),
                (_this.props.value === 'yes' || _this.props.value === 'no') && _react2.default.createElement(
                    _core.Button,
                    { variant: 'flat', color: 'primary',
                        onClick: function onClick(e) {
                            return _this.props.onChangeValidate(e, 'unanswered');
                        } },
                    'clear response'
                )
            );
