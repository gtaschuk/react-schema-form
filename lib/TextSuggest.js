...
var TextSuggest = function (_Component) {
    _inherits(TextSuggest, _Component);
    ...
    function TextSuggest() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = TextSuggest.__proto__ || Object.getPrototypeOf(TextSuggest)).call.apply(_ref, [this].concat(args))), _this), _this.handleUpdate = function (newValue) {
